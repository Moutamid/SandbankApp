...
import com.moutamid.myapplication.UserTransferData;
...
public class DatabaseHelper extends SQLiteOpenHelper {
    ...
    public UserData getUserData(String userId) {
        ...
        if (cursor.moveToFirst()) {
            ...
            String dni = cursor.getString(cursor.getColumnIndex(COL_DNI));
            String email = cursor.getString(cursor.getColumnIndex(COL_EMAIL));
            String phoneNumber = cursor.getString(cursor.getColumnIndex(COL_PHONE_NUMBER));
            ...
            String street = cursor.getString(cursor.getColumnIndex(COL_STREET));
            String streetNumber = cursor.getString(cursor.getColumnIndex(COL_STREET_NUMBER));
            String floor = cursor.getString(cursor.getColumnIndex(COL_FLOOR));
            String postalCode = cursor.getString(cursor.getColumnIndex(COL_POSTAL_CODE));
            ...
            String total_amount = cursor.getString(cursor.getColumnIndex(COL_TOTAL_AMOUNT));
            String iban = cursor.getString(cursor.getColumnIndex(COL_IBAN));
    ...
    public List<UserTransferData> getAllUserTransferData(String userId) {
        ...
        try {
            if (cursor != null && cursor.moveToFirst()) {
                do {
                    String destinationIBAN = cursor.getString(cursor.getColumnIndex(COL_DESTINATION_IBAN));
                    String recipientPhoneNumber = cursor.getString(cursor.getColumnIndex(COL_RECIPIENT_PHONE_NUMBER));
                    String purposeOfTransfer = cursor.getString(cursor.getColumnIndex(COL_PURPOSE_TRANSFER));
                    String amountToTransfer = cursor.getString(cursor.getColumnIndex(COL_AMOUNT_TRANSFER));
